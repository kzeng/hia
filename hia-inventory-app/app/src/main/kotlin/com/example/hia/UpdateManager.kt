...
object UpdateManager {
    ...
    private fun getDownloadFile(context: Context): File {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            File(downloadsDir, "hia-update-${System.currentTimeMillis()}.apk")
        } else {
            // Android 9 and below - Try to save to public Downloads directory
            ...
            if (downloadsDir != null && downloadsDir.exists()) {
                ...
                File(fallbackDir, "hia-update-${System.currentTimeMillis()}.apk")
            }
        }
    }
    ...
    private fun downloadApk(context: Context, urlStr: String, onProgress: ((Int) -> Unit)? = null): DownloadResult {
        ...
        while (retryCount < maxRetries) {
            try {
                ...
                android.util.Log.d("UpdateManager", "响应头: $headers")
                ...
                if (responseCode == HttpURLConnection.HTTP_MOVED_TEMP || 
                    ...
                    android.util.Log.d("UpdateManager", "重定向到: $location")
                }
                ...
                if (!isSuccess) {
                    ...
                    try {
                        ...
                        if (errorStream != null) {
                            ...
                            android.util.Log.e("UpdateManager", "错误响应: $errorText")
                        }
                    } catch (e: Exception) {
                        android.util.Log.e("UpdateManager", "无法读取错误流", e)
                    }
                    // 如果是服务器错误，可以重试
    ...
    private fun installApk(context: Context, apkFile: File): InstallResult {
        ...
        android.util.Log.d("UpdateManager", "Intent data: ${intent.data}")
        android.util.Log.d("UpdateManager", "Intent type: ${intent.type}")
        android.util.Log.d("UpdateManager", "Intent flags: ${intent.flags}")
        ...
        for (activity in activities) {
            android.util.Log.d("UpdateManager", "可用活动: ${activity.activityInfo.packageName}/${activity.activityInfo.name}")
        }
